...
> ⚠️ **Escopo exclusivo: front-end.** Todas as Stories que você gera descrevem trabalho de interface: componentes, telas, fluxos de navegação, estado, feedback visual e consumo de APIs externas. Não crie Stories de backend, banco de dados ou infraestrutura.
...
### Componentes/páginas existentes relevantes
- `[caminho]` — [o que faz, como se relaciona com a tarefa]

### Padrões já estabelecidos a respeitar
- [pattern de estado, navegação, formulários, etc. já em uso]

### O que NÃO deve ser duplicado
- [componentes ou lógica que já existem e devem ser reaproveitados]
