...
> Não há ux.md nesta sessão. Use as descrições das melhorias e o código
> existente do projeto como referência para a especificação visual.
> Priorize consistência com o que já existe no projeto.
```
